...
% Auteur
\author{Xavier, \textsc{aka schxOO6} \thanks{schx006@xs-net.io} \\
Geek}
...
dans différents environnement \em{Mac OS, Linux, MS Windows},
grâce à la disponibilité des fichiers sources sur le \enquote{repositoru Github}.
\end{abstract}
