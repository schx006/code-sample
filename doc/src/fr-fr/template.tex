...
\usepackage{subfiles}            % Permets de scinder chaque partie dans un fichier…
                                 % … et de les regrouper dans un sous-répertoire
...
%\grapicspath{img/}               % Sous-répertoire pour les images : "img/"
...
%  \thanks{funded by … team} \\           % Note de bas de page de "remerciement"
...
\subfile{sections/introduction}           % les différentes parties sont dans les
                                          % fichiers du sous-répertoire "sections/"
